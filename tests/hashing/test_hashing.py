...
class TestHashData(unittest.TestCase):
    ...
    def _simple_test(self, hash_type: HT, data: bytes, expected: Union[bytes, str]) -> None:
    ...
    def _complex_test(self, hash_type: HT, hash_len: int, num_iters: int = 100) -> None:
    ...
    def test_md5_basic(self):
        """Basic MD5 test"""
        self._simple_test(HT.MD5, b"\x00" * 3, "693e9af84d3dfcc71e640e005bdc5e2e")

    def test_md5_random(self):
        """MD5 test on more random samples"""
        self._complex_test(HT.MD5, 16)

    def test_sha1_basic(self):
        """Basic SHA1 test"""
        self._simple_test(HT.SHA1, b"\x00" * 3, "29e2dcfbb16f63bb0254df7585a15bb6fb5e927d")

    def test_sha1_random(self):
        """SHA1 test on more random samples"""
        self._complex_test(HT.SHA1, 20)
    ...
    def test_sha224_basic(self):
        ...
        self._simple_test(
            HT.SHA224,
            b"\x00" * 3,
            ("8e25d811cf8fb0998f130c33062a4162edcf418a621ab04145489337"),
        )

    def test_sha224_random(self):
        """SHA224 test on more random samples"""
        self._complex_test(HT.SHA224, 224 // 8)
    ...
    def test_sha3_224_basic(self):
        ...
        self._simple_test(
            HT.SHA3_224,
            b"\x00" * 3,
            ("eb3043283ebd5b64c6aedeca57ccc52bd6c51d2c780f3063314a2c6a"),
        )

    def test_sha3_224_random(self):
        """SHA3_224 test on more random samples"""
        self._complex_test(HT.SHA3_224, 224 // 8)
    ...
    def test_sha256_random(self):
        ...
        self._complex_test(HT.SHA256, 256 // 8)
    ...
    def test_sha3_256_basic(self):
        ...
        self._simple_test(
            HT.SHA3_256,
            b"\x00" * 3,
            ("4f808a691382f10c81d6bbad4a2016bf155f36623197b97e3bb47afec194cead"),
        )

    def test_sha3_256_random(self):
        """SHA3_256 test on more random samples"""
        self._complex_test(HT.SHA3_256, 256 // 8)
    ...
    def test_sha384_random(self):
        ...
        self._complex_test(HT.SHA384, 384 // 8)
    ...
    def test_sha3_384_random(self):
        ...
        self._complex_test(HT.SHA3_384, 384 // 8)
    ...
    def test_sha512_random(self):
        ...
        self._complex_test(HT.SHA512, 512 // 8)
    ...
    def test_sha3_512_random(self):
        ...
        self._complex_test(HT.SHA3_512, 512 // 8)
